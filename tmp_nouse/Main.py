...
if __name__ == "__main__":
    MP=MainProc()
    MP.update_ZDT_stocksNum_ALL(dateEq="20160815")
    MP.update_freshStocks(dateEq="20160815")
    ...
    MP.update_ZDT_contsNum(dateEq="20160815")
    MP.update_ZDT_yesterday(dateEq="20160815")